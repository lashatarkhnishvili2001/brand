...
export const ButtonLargeBlue = ({ text }) => {
    return <button className="ButtonLargeBlue button"> <span>{text}</span></button>;
};
...
export const ButtonNormalWhite = ({ text }) => {
    return <button className="ButtonNormalWhite button"> <span>{text}</span></button>;
}
